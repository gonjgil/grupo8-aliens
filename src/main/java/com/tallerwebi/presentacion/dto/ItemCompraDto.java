...
public class ItemCompraDto {
    ...
    public String getObraImagenUrl() {
        return obraImagenUrl;
    }

    public void setObraImagenUrl(String obraImagenUrl) {
        this.obraImagenUrl = obraImagenUrl;
    }

    public Double getObraPrecio() {
        return obraPrecio;
    }

    public void setObraPrecio(Double obraPrecio) {
        this.obraPrecio = obraPrecio;
    }
